...
# Upload ccache.tar.gz to transfer.sh and print the url output so the we can use it to download ccache.tar.gz at the time of re-building
time curl --upload-file ./ccache.tar.gz https://transfer.sh/ccache.tar.gz
