...
tg(){
	bot_api=1858249904:AAEVTAnBzE-EHdljK12LSb2DfJrRra1aAKk # Your tg bot api, dont use my one haha
...
id=1724706622 # Your telegram id
...
make bacon -j10 \
	&& send_zip=$(up out/target/product/pine/*zip) && tg $id "Build Succeed!
$send_zip" \
